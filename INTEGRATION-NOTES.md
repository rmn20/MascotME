...
If your MIDP implementation uses int[] framebuffer, just pass your framebuffer to MascotME in Graphics3D.bind and remove Graphics3D.clearFB, clearFBAlpha and drawFB methods.  
...
## Hacks  
If you solved some of the aforementioned issues, please remove support of the corresponding hacks, such as fbClearColor, fbSizeWorkaround, doNotClear, useArrayCopyClear, or other.  
